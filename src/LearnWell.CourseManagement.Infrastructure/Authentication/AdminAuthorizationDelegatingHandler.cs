using LearnWell.CourseManagement.Infrastructure.Authentication.Models;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.Extensions.Options;
using System.Net.Http.Headers;
using System.Net.Http.Json;

namespace LearnWell.CourseManagement.Infrastructure.Authentication;
public sealed class AdminAuthorizationDelegatingHandler : DelegatingHandler
{
    ...
    private async Task<AuthorizationToken> GetAuthorizationToken(CancellationToken cancellationToken)
    {
        ...
        var authorizationRequest = new HttpRequestMessage(
            HttpMethod.Post,
            new Uri("http://coursemanagement:8080/auth/realms/coursemanagement/protocol/openid-connect/token"))
        { 
